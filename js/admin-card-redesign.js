...
(function(){
  ...
  function html(){
    ...
    return `<div class="admin-section"><div class="admin-section-title">✨ Mega-Fix 23: Card UX Redesign</div>
      <p style="font-size:13px;color:var(--ink-2);line-height:1.55;margin-bottom:14px">Neue Premium-Karte nach dem Mockup. Dieser Testbereich bleibt nur im Produktkatalog, damit die Betriebszentrale nicht überladen wird.</p>
      ...
      <p style="font-size:11px;color:var(--ink-3);line-height:1.45;margin-top:10px"><b>Prüfen:</b> Bildwirkung, CTA, Textlänge, rechter Seitenabstand und ob die Karte sofort hochwertiger wirkt.</p>
    </div>`;
  }
  function patchAdminPage(){
    try{
      ...
      const patched=function(tab){const out=original(tab);if(tab==='catalog')return String(out)+html();return out;};
